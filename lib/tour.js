...
(function () {
  ...
  const TOURS = {
    'index.html': [
      ...
      ['#trigSel', '이 동작이 나오면 찰칵 해요.\n내가 가르친 제스처도 고를 수 있어요.'],
      ['#holdSlider', '동작을 얼마나 유지해야\n찍을지 정해요.'],
      ['#camBtn', '카메라를 켜요.\n동작을 해 보면 게이지가 차요.'],
      ['#bgSel', '배경도 바꿔서 찍을 수 있어요.\nAI가 사람과 배경을 나눠요.'],
      ['#strip', '찍은 사진은 여기에 쌓여요.\n갤러리에서 내려받을 수 있어요.'],
    ],
    'train.html': [
      [null, '여기서 나만의 동작을 가르쳐요.\n가르친 동작은 셔터가 돼요.'],
      ['#clsName', '셔터로 쓸 동작과,\n그게 아닌 평소 모습을 각각 만들어요.'],
      ['#capBtn', '동작을 고르고 꾹 눌러서\n예시를 모아요.'],
      ['#trainBtn', '예시를 다 모으면\n배우기 시작을 눌러요.'],
      ['#mdlName', '이름을 짓고 저장하면\n촬영실 셔터 목록에 나와요.'],
    ],
    'gallery.html': [
      [null, '여기는 갤러리예요.\n찍은 사진이 모여 있어요.'],
      ['#phGrid', '사진을 누르면 크게 보고\n내려받을 수 있어요.'],
      ['#panModels', '가르친 제스처도 여기서\n관리해요.'],
    ],
  };
